...
document.getElementById('signup-btn').addEventListener('click', () => {
    ...
    loginSignupContainer.style.display = 'none';
    inputContainer.style.display = 'block'; // 회원가입 후 아이디 입력 창 표시
    // 아이디 입력 창 초기화 (선택 사항)
...
document.getElementById('save-btn').addEventListener('click', () => {
    ...
    const memo = document.getElementById('memo').value; // 메모 추가

    const newId = { companyName, siteName, userId, userPw, memo }; // 메모 추가
...
document.getElementById('edit-btn').addEventListener('click', () => {
    ...
    if (selected) {
        ...
        document.getElementById('memo').value = selectedId.memo; // 메모 추가
